	...
	return (
		<Box mbs={16}>
			...
			<Box display='flex' alignItems='center' mbs={12} mbe={8}>
				<Icon name='ai' size='x20' mie={8} color='hint' />
			...
			<Box mbe={8}>
				<ButtonGroup stretch>
					<Button small disabled={pending} onClick={() => generateMutation.mutate('summary')}>
						{pending && activeTask === 'summary' ? <Throbber inheritColor size='x12' mie={4} /> : <Icon name='ai' size='x14' mie={4} />}
			...
			{pending && (
				<Box display='flex' alignItems='center' fontScale='c1' color='hint' mbe={8}>
					<Throbber size='x12' mie={8} />
