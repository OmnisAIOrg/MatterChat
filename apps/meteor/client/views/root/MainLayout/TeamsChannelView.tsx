 ...
 *  - Every `selectedTeamsChannel` / `teamsConnection` / `messages` access is optional-chained or
 *    null-guarded — nothing is dereferenced blindly.
 */
...
const TeamsChannelView = (): ReactElement => {
	...
	// No channel chosen yet — quiet placeholder inviting a pick from the Teams sidebar. This is the
	// ONLY early return, and it comes AFTER every hook above, so hook order is always stable.
